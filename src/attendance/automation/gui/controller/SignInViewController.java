...
public class SignInViewController implements Initializable
{
    ...
    private void handleSignIn(ActionEvent event)
    {
        ...
        Student s = new Student("placeholder", user, modelfacade.hashPassword(pass), 0, "placeholder", 0);
        Teacher t = new Teacher("placeholder", user, modelfacade.hashPassword(pass));
